...
partial record DeclFuncAst(Visibility visibility, TypeAst retType, string realName, string asmName, ParamAst[] paramz, bool vaArg, CallConv conv): StmtAst;
partial record FuncAst(Visibility visibility, TypeAst retType, string realName, string asmName, ParamAst[] paramz, bool vaArg, CallConv conv, StmtAst[] body): StmtAst;
