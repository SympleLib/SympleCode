...
namespace Symple
{
	static const TypeNode* sStringType = new TypeNode(Type::PrimitiveType::Char, new TypeModifiersNode({}), new TypeContinueNode(new Token(Token::Kind::Asterisk, "*", 1, ""), new TypeModifiersNode({}), nullptr));
